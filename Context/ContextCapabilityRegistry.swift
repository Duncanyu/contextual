	...
	private func seedInitialCapabilities() {
		...
		register(
			ContextCapability(
				...
				supportsManualInvocation: false,
				supportsBackgroundCollection: false,
				notes: "Metadata-only keyDown timing/counts; may depend on macOS Input Monitoring privacy settings for global events.",
				sourceVersion: nil,
				metadata: nil,
				lastAvailabilityCheckedAt: nil,
				lastUpdatedAt: nil,
		...
		register(
			ContextCapability(
				...
				supportsManualInvocation: false,
				supportsBackgroundCollection: false,
				notes: "Metadata-only pointer timing/counts; may depend on macOS Input Monitoring privacy settings for global events.",
				sourceVersion: nil,
				metadata: nil,
				lastAvailabilityCheckedAt: nil,
				lastUpdatedAt: nil,
